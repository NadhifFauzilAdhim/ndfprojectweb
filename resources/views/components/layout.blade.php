...
<head>
    ...
    <meta name="description"
        content="{{ $description ?? 'Web development services, custom solutions, and digital innovation. Transform your ideas into reality with our expert team.' }}">
    <meta name="keywords"
        content="web development, digital solutions, custom websites, web design, programming, software development">
    ...
    <meta property="twitter:description"
        content="{{ $description ?? 'Web development services and digital solutions' }}">
    ...
    <!-- Fonts -->
    <link
        href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@300;400;600;700&family=Raleway:wght@300;400;500;600;700&family=Poppins:wght@300;400;500;600;700&display=swap"
        rel="stylesheet">
...
<body>
    <div id="spinner" class="spinner-wrapper">
        <div class="text-center d-flex">
            ...
            <p class="text-white ms-2" style="font-family: 'Courier New', Courier, monospace">Optimizing ... Just a
                moment!</p>
        </div>
    </div>
