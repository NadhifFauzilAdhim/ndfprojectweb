<nav id="navbar" class="nav-menu navbar">
  <ul>
      ...
      <!-- Dropdown for Blog and Event -->
      <li class="dropdown">
          <a href="#" class="nav-link scrollto dropdown-toggle" data-bs-toggle="dropdown" role="button" aria-expanded="false">
              <i class="bi bi-pencil-square fs-5"></i> <span>Discover</span></i>
          </a>
          <ul class="dropdown-menu">
              <li><a href="/blog" class="{{ request()->is('blog') ? 'dropdown-item active' : 'dropdown-item' }} text-dark bg-transparent""><i class="bi bi-pencil-square fs-5"></i> Blog</a></li>
              <li><a href="/event" class="{{ request()->is('event') ? 'dropdown-item active' : 'dropdown-item' }} text-dark bg-transparent"><i class="bi bi-people-fill fs-5"></i> Event</a></li>
          </ul>
      </li>
