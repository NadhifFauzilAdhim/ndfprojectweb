<nav id="navbar" class="nav-menu navbar">
    <ul>
        ...
        <li class="dropdown">
            <a href="#" class="nav-link scrollto dropdown-toggle py-1" data-bs-toggle="dropdown" role="button" aria-expanded="false">
                <i class="bi bi-pencil-square" style="font-size: 1.50em;"></i> <span>Discover</span>
            </a>
            <ul class="dropdown-menu">
                <li><a href="/blog" class="{{ request()->is('blog') ? 'dropdown-item active' : 'dropdown-item' }} text-dark bg-transparent"><i class="bi bi-pencil-square"></i> My Blog</a></li>
                <li><a href="/event" class="{{ request()->is('event') ? 'dropdown-item active' : 'dropdown-item' }} text-dark bg-transparent"><i class="bi bi-calendar-event"></i> Event</a></li>
            </ul>
        </li>
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
                <li><a href="/dashboard" class="dropdown-item text-dark bg-transparent"><i class="bi bi-speedometer2"></i> Dashboard</a></li>
                <li>
