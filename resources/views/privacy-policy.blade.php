    ...
    <div class="container terms-container my-5">
        <div class="card shadow-sm border-light">
            <div class="card-header bg-white text-center py-4">
                ...
                <p class="text-muted mb-0">For the FocusEye Application</p>
            </div>
            <div class="card-body p-4 p-md-5">
                <p class="lead">These terms and conditions apply to the FocusEye app (hereby referred to as "Application") for mobile devices that was created by NDFProject (hereby referred to as "Service Provider") as an Open Source service.</p>
                ...
                <div>
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item"><a href="https://policies.google.com/terms" target="_blank" rel="noopener noreferrer">Google Play Services</a></li>
                        <li class="list-group-item"><a href="https://onesignal.com/tos" target="_blank" rel="noopener noreferrer">One Signal</a></li>
                    </ul>
                </div>
                
                <p class="mt-3">Please be aware that the Service Provider does not assume responsibility for certain aspects. Some functions of the Application require an active internet connection, which can be Wi-Fi or provided by your mobile network provider. The Service Provider cannot be held responsible if the Application does not function at full capacity due to lack of access to Wi-Fi or if you have exhausted your data allowance.</p>
                ...
                <h2 class="h4">Changes to These Terms and Conditions</h2>
                ...
                <p><strong>These terms and conditions are effective as of 2025-06-16</strong></p>
                
                <h2 class="h4">Contact Us</h2>
                <p>If you have any questions or suggestions about the Terms and Conditions, please do not hesitate to contact the Service Provider at <a href="mailto:nadhifauzil@gmail.com">nadhifauzil@gmail.com</a>.</p>
                
                <hr class="my-4">
                
                <div class="text-center text-muted">
                    <small>This Terms and Conditions page was generated by <a href="https://app-privacy-policy-generator.nisrulz.com/" target="_blank" rel="noopener noreferrer">App Privacy Policy Generator</a></small>
                </div>
            </div>
        </div>
    </div>
