                                    ...
                                    <div class="card mt-4 border-0 shadow-sm">
                                        <div class="card-body">
                                            ...
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="passwordProtectionSwitch" name="password_protected" {{ $link->password_protected ? 'checked' : '' }}>
                                                <label class="form-check-label" for="passwordProtectionSwitch">Require Password</label>
                                            </div>
                                            <input type="password" class="form-control mt-3 shadow-sm" id="password" name="password" placeholder="Enter password (optional)">
