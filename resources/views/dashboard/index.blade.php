...
<body>
      ...
      <div>
        <div class="brand-logo d-flex align-items-center justify-content-between">
          <a href="/" class="text-nowrap logo-img">
            <img src="{{ asset('img/ndflogo.png') }}" alt="" width="200px" class="ms-3 mt-4"/>
          </a>
          ...
          <div class="navbar-collapse justify-content-end px-0" id="navbarNav">
            <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
              <a href="#" target="_blank"
                class="btn btn-primary me-2"><span class="d-none d-md-block">{{ auth()->user()->name }}</span> <span class="d-block d-md-none">Pro</span></a>
  ...
  <script src="vendor/simplebar/dist/simplebar.js"></script>
